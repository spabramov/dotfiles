...
map('n', ']t', ':tabnext<CR>', { desc = 'Move focus to the next window' })
map('n', '[t', ':tabprevious<CR>', { desc = 'Move focus to the previous window' })

map('n', ']b', ':bnext<CR>', { desc = 'Go to the next [B]uffer' })
map('n', '[b', ':bprevious<CR>', { desc = 'Go to the previous [B]uffer' })
map('n', ']c', ':cnext<CR>', { desc = 'Go to the next qui[C]k fix' })
map('n', '[c', ':cprevious<CR>', { desc = 'Go to the previous qui[C]k fix' })
...
map('v', '<M-j>', ":m '>+1<cr>gv=gv", { desc = 'Move down block' })
map('v', '<M-k>', ":m '<-2<cr>gv=gv", { desc = 'Move up block' })
